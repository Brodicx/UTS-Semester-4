...
# Load data
try:
    df = pd.read_csv("komentar_dokterjadipredator5.csv")
...
# Simpan hasil
df.to_csv("komentar_sentimen6.csv", index=False)
print("\nFile berhasil disimpan: komentar_sentimen6.csv")
